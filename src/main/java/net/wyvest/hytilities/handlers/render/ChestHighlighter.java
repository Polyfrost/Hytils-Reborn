...
package net.wyvest.hytilities.handlers.render;
...
public class ChestHighlighter {
    ...
    private void drawBoundingBox(RenderWorldLastEvent event, BlockPos pos) {
        ...
        drawFilledBoundingBox(new AxisAlignedBB(x, y, z, x + 1, y + 1, z + 1).expand(0.01, 0.01, 0.01), HytilitiesConfig.highlightChestsColor);
    ...
    private boolean isNotSupported() {
        return Hytilities.INSTANCE.getLocrawUtil().getLocrawInformation() == null || (Hytilities.INSTANCE.getLocrawUtil().getLocrawInformation().getGameType() != GameType.SKY_WARS && Hytilities.INSTANCE.getLocrawUtil().getLocrawInformation().getGameType() != GameType.BLITZ_SG && (Hytilities.INSTANCE.getLocrawUtil().getLocrawInformation().getGameType() != GameType.DUELS || !Hytilities.INSTANCE.getLocrawUtil().getLocrawInformation().getGameMode().contains("_SW_")));
    }
}
